...
export function lampForIncidence(
  ...
  const light = collimatedLightBetween(
    [
  ...
  // Reflect the source across the upright prism: white enters left, spectrum exits right.
  return { ...light, center: [-light.center[0], light.center[1]], direction: [-light.direction[0], light.direction[1]] };
}
